...
@section('content')
  ...
  <div class="flex-container row col-sm-12 col-md-12 col-lg-12">
   <div class="card flex-card col-sm-6 col-md-3 col-lg-3" >
      ...
      @endif
        <a href="/home?thumbnail={{ $item["thumbnail"] }}&title={{ $item["title"] }}" class="btn btn-primary">登録</a> <a href="https://www.amazon.co.jp/s?k={{ $item["title"] }}" target="_blank" class="btn btn-default">Amazonで購入</a>
      </div><!-- card-body -->
   </div><!-- card flex-card -->
