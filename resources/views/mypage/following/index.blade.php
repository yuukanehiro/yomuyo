                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header"></div>
                            <div class="card-body">
                                <h2>
                                    <b>{{ $user->name }}</b> さんがフォローしているユーザ一覧
                                </h2>
                                @foreach($following_recs as $following_rec)
                                    <a href="/user/?user_name={{ $following_rec->user_name }}&user_id={{ $following_rec->user_id }}"><img src="{{ asset('/images/profile_default_icon.gif') }}"> {{ $following_rec->user_name }}</a>
                                    {{ $following_rec->user_comment }}
                                    <hr/>
                                @endforeach
                                <hr>
